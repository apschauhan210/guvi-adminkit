...
export class DashboardComponent implements OnInit {
    ...
    this.cardDataList = [
      {
        title: "Sales",
        number: "2.382",
        percentage: {scale: -3.65, textClass: "text-danger"},
      ...
      },
      {
        title: "Visitors",
        number: "14.212",
        percentage: {scale: 5.25, textClass: "text-success"},
        svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users align-middle"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>'
      },
      {
        title: "Earnings",
        number: "$21.300",
        percentage: {scale: 6.65, textClass: "text-success"},
      ...
      },
      {
        title: "Orders",
        number: "64",
        percentage: {scale: -2.25, textClass: "text-danger"},
  ...
  ngOnInit(): void {
    this.navBarService.setActive('nav-dashboard');
  }
}
...
export interface CardData {
  title: string,
  number: string, 
  percentage: {scale: number, textClass: string},
  svg: string,
}
